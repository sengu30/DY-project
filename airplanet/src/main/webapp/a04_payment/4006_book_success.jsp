...
<div class="row mb-5">
<button class="col btn btn-primary mx-2" onclick="location.href='/a03_myPage/3001_myPage_Main.jsp'">마이페이지</button>
<button class="col btn btn-primary mx-2" onclick="location.href='/a02_search/2000_main.jsp'" >에어플래닛 메인</button>
</div>
